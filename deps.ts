...
export { methods } from "https://deno.land/x/opine@1.3.3/src/methods.ts";
export { mergeDescriptors } from "https://deno.land/x/opine@1.3.3/src/utils/mergeDescriptors.ts";
