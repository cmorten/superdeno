...
export { STATUS_TEXT } from "https://deno.land/std@0.58.0/http/http_status.ts";
...
export { mergeDescriptors } from "https://deno.land/x/opine@0.12.0/src/utils/mergeDescriptors.ts";
