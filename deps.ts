...
export { STATUS_TEXT } from "https://deno.land/std@0.99.0/http/http_status.ts";
export { assertEquals } from "https://deno.land/std@0.99.0/testing/asserts.ts";
export { methods } from "https://deno.land/x/opine@1.5.3/src/methods.ts";
export { mergeDescriptors } from "https://deno.land/x/opine@1.5.3/src/utils/mergeDescriptors.ts";
