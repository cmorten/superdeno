...
<p align="center">
   ...
   <a href="https://github.com/denoland/deno/blob/main/Releases.md"><img src="https://img.shields.io/badge/deno-^1.14.2-brightgreen?logo=deno" alt="Minimum supported Deno version" /></a>
...
```ts
import { superdeno } from "https://x.nest.land/superdeno@4.6.0/mod.ts";
```
...
import { opine } from "https://deno.land/x/opine@1.7.2/mod.ts";
import { superdeno } from "https://deno.land/x/superdeno@4.6.0/mod.ts";
export { expect } from "https://x.nest.land/expect@0.2.9/mod.ts";
