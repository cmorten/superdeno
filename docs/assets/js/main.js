!function () {
  ...
  e.version = "2.3.7",
    ...
    e.Set.prototype.union = function (t) {
      return t === e.Set.complete ? e.Set.complete
      : t === e.Set.empty ? this
        ...
        if (0 != s.editsRemaining) {
          ...
          if (
            0 == s.str.length && (u.final = !0),
              n.push(
                { node: u, editsRemaining: s.editsRemaining - 1, str: s.str },
              ),
              1 < s.str.length &&
              n.push(
                {
    ...
    e.TokenSet.Builder.prototype.insert = function (t) {
      ...
      for (
        var n = 0;
        n < t.length && n < this.previousWord.length &&
    ...
    e.Index.prototype.query = function (t) {
      ...
      for (u = 0; u < r.clauses.length; u++) {
        ...
        for (var d = 0; d < c.length; d++) {
          ...
          if (0 === y.length && l.presence === e.Query.presence.REQUIRED) {
            for (var m = 0; m < l.fields.length; m++) {o[v = l.fields[m]] =
                e.Set.empty;}
            break;
          }
      ...
      for (u = 0; u < C.length; u++) {
        ...
        if (R.contains(D) && !F.contains(D)) {
          var A, B = this.fieldVectors[j], V = n[j.fieldName].similarity(B);
      ...
      t.version != e.version &&
        e.utils.warn(
          "Version mismatch when loading serialised index. Current version of lunr '" +
            e.version + "' does not match serialized index '" + t.version + "'",
        );
    ...
    e.Builder.prototype.createFieldVectors = function () {
      for (
        ...
        for (
          ...
          var m, v, g, x = h[y], w = c[x], Q = this.invertedIndex[x]._index;
          void 0 === n[x]
    ...
    e.Query.prototype.clause = function (t) {
      return "fields" in t || (t.fields = this.allFields),
        ...
        t.term.charAt(0) != e.Query.wildcard && (t.term = "*" + t.term),
        t.wildcard & e.Query.wildcard.TRAILING &&
        t.term.slice(-1) != e.Query.wildcard && (t.term = t.term + "*"),
    ...
    function (e, t) {
      ...
      : "object" == typeof exports ? module.exports = t() : e.lunr = t();
    }(this, function () {
      return e;
    });
}();
...
!function (typedoc) {
  ...
  var Application = function () {
    ...
    return Application.prototype.createServices = function () {
  ...
  function (typedoc) {
    var EventTarget = function () {
      ...
      return EventTarget.prototype.addEventListener = function (
        type,
        callback,
      ) {
  ...
  function (typedoc) {
    var Viewport = function (_super) {
      ...
      return __extends(Viewport, _super),
  ...
  function (typedoc) {
    var FilterItem = function () {
      ...
      FilterItemSelect = function (_super) {
        ...
        return __extends(FilterItemSelect, _super),
      ...
      Filter = function (_super) {
        function Filter(options) {
          ...
          return _this.optionVisibility = new FilterItemSelect(
            "visibility",
            "private",
          ),
    ...
    Filter.isSupported() ? typedoc.registerComponent(Filter, "#tsd-filter")
      ...
      return __extends(MenuHighlight, _super),
        MenuHighlight.prototype.createAnchors = function () {
          ...
          (base = base.substr(0, base.indexOf("#"))),
            this.el.querySelectorAll("a").forEach(function (el) {
              var href = el.href;
              if (
                -1 != href.indexOf("#") && href.substr(0, base.length) == base
              ) {
                ...
                anchor && link &&
                  _this.anchors.push(
                    { link: link, anchor: anchor, position: 0 },
                  );
              }
            }),
            this.onResize();
        ...
        MenuHighlight.prototype.onResize = function () {
          for (
            ...
            var rect = (anchor = this.anchors[index]).anchor
  ...
  function (typedoc) {
    !function (search) {
      ...
      var Search = function (_super) {
        ...
        return __extends(Search, _super),
          ...
          Search.prototype.gotoCurrentResult = function () {
            ...
            if (
              current ||
              (current = this.results.querySelector("li:first-child")), current
            ) {
            ...
            this.results.addEventListener("mousedown", function () {
              ...
              document.body.addEventListener("keydown", function (e) {
                e.altKey || e.ctrlKey || e.metaKey ||
                  !_this.hasFocus && 47 < e.keyCode && e.keyCode < 112 &&
                    _this.field.focus();
              });
          },
          Search;
  ...
  function (typedoc) {
    var SignatureGroup = function () {
      ...
      Signature = function (_super) {
        ...
        return __extends(Signature, _super),
  ...
  function (typedoc) {
    var Toggle = function (_super) {
      ...
      return __extends(Toggle, _super),
        Toggle.prototype.setActive = function (value) {
          if (this.active != value) {
            ...
            var transition = (this.active ? "to-has-" : "from-has-") +
              this.className;
        ...
        Toggle.prototype.onDocumentPointerUp = function (e) {
          var _this = this;
          if (
            !typedoc.hasPointerMoved && this.active &&
